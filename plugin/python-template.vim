...
function! g:LoadPythonFileTemplate()
python << EOF
import os
import tempfile
import vim
...
templateFile = os.path.join(selfRootPath, "templates", "python.mako")
...
if has("autocmd")
	autocmd BufNewFile *.py call g:LoadPythonFileTemplate() 
	autocmd BufNewFile *.pyw call g:LoadPythonFileTemplate() 
endif
