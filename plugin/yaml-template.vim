...
function! g:LoadYamlFileTemplate()
python << EOF
import os
import tempfile
import vim
...
templateFile = os.path.join(selfRootPath, "templates", "yaml.mako")
...
if has("autocmd")
	autocmd BufNewFile *.yaml call g:LoadYamlFileTemplate()
	autocmd BufNewFile *.yml call g:LoadYamlFileTemplate()
endif
